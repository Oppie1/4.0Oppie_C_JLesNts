...
int main() {
	...
	//Lastly maxAmount which will will be initialized to 10; 
	//of iterations program can have. 
	//Code:
	...
	//Scan in the user int selection. Leave a blank before to clear the buffer of garbage data. Then use
	...
	//a by 2 each iteration.
	//CODE:

		//print the current value of i on its own line each iteration.
		//CODE:
